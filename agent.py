...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
	    ...
	    self.epsilon = math.exp(-(self.t*self.a))
        return None
    ...
    def build_state(self):
        ...
        state = string(waypoint) + "," + inputs['light'] + "," + string(inputs['left']) + ","  +  string(inputs['oncoming'])
	# + string(inputs['right']) + "," #conditionally important
        if self.learning:
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=1.0, alpha=0.015)
